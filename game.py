...
def welcomescreen():
    ...
    while True:
        for event in pygame.event.get():
            ...
            #if the user presses space or up key key, start the game for them
...
def mainGame():
    ...
    #create 2 pipes for blitting ont the screen
    ...
    playerFlapped = False #it is true when bird flapping
...
def getRandomPipe():
    """
    Generate positions of two pipes(one bottom straight and one top rotated) and blitting them on screen
